defmodule LmBackendWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LmBackendWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LmBackendWeb.Gettext, "errors", msg, opts)
    end
  end
