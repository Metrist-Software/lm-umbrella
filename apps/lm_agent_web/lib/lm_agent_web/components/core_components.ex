defmodule LmAgentWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LmAgentWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LmAgentWeb.Gettext, "errors", msg, opts)
    end
  end
